        ...
        <div class="page-content container-fluid">
          <div class="row" data-plugin="matchHeight" data-by-row="true">
            ...
            <div class="panel">
              ...
              <form action="{{route('artikel.edit',$artikel->slug)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  <input type="text" class="form-control" id="inputText" name="judul" value="{{old('judul') ?? $artikel->judul}}" placeholder="Judul">
                  ...
                  @foreach ($kategoris as $k)
                    <div class="checkbox-custom checkbox-primary">
                      <input type="checkbox" name="kategori[]" id="inputUnchecked" value="{{$k->id}}" @if($artikel->kategoris->pluck('id')->contains($k->id)) checked @endif>
                  ...
                  <textarea class="form-control" id="textarea" name="desc" rows="3">{{old('desc') ?? $artikel->desc}}</textarea>
                    @error('desc')
                    <span class="text-danger">{{$message}}</span>
                  ...
                  <div class="form-group form-material" data-plugin="formMaterial">
                  <textarea name="isi" id="summernote" data-plugin="summernote">{{old('isi') ?? $artikel->isi}}</textarea>
                  @error('isi')
                    <span class="text-danger">{{$message}}</span>
